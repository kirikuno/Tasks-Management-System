...
<html dir="ltr" lang="en">
  <head>
    ...
    />
    <title>
      AdminBite admin Template - The Ultimate Multipurpose admin template
    </title>
    <!-- Custom CSS -->
    <link
          ...
          <div class="navbar-collapse collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav float-left mr-auto">
                      ...
                      <ul class="list-style-none">
                        <li>
                          <a href="javascript:void(0)">
                            <i class="fa fa-check text-success"></i> You can
                            give link</a
                          >
                        </li>
                        <li>
                          <a href="javascript:void(0)">
                            <i class="fa fa-check text-success"></i> Give
                            link</a
                          >
                        </li>
                        <li>
                          <a href="javascript:void(0)">
                            <i class="fa fa-check text-success"></i> Another
                            Give link</a
                          >
                        </li>
                        <li>
                          <a href="javascript:void(0)">
                            <i class="fa fa-check text-success"></i> Forth
                            link</a
                          >
                        </li>
                        <li>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu mailbox animated bounceInDown">
                  ...
                  <ul class="list-style-none">
                    ...
                    <li>
                      <a
                        class="nav-link text-center m-b-5"
                        href="javascript:void(0);"
                      >
              ...
              <li class="nav-item dropdown">
                ...
                <div
                  class="dropdown-menu mailbox animated bounceInDown"
                  aria-labelledby="2"
                >
                  <span class="with-arrow">
          ...
          <div class="row m-t-30">
            <div class="col-md-4">
                <div class="card text-white bg-primary">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white">To Do</h4></div>
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card text-white bg-danger">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white">Doing</h4></div>
                    <div class="card-body">
                        <h3 class="card-title">Special title treatment</h3>
                        <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
