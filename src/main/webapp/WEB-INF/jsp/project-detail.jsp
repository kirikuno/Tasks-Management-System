			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Choose Role</h4>
								<h6 class="card-subtitle">Message choose role or non-choose
									role</h6>
								<form class="form-horizontal p-t-20">
									<div class="form-group row">
										...
										<div class="col-md-9">
											<select class="form-control custom-select">
												<option value="">dev1</option>
												<option value="">Dev2</option>
												<option value="">Dev3</option>
												<option value="">Dev4</option>
									...
									<div class="form-group row m-b-0">
										<div class="offset-sm-3 col-sm-9">
											<button type="submit"
												class="btn btn-info waves-effect waves-light">Confirm</button>
										</div>
									</div>
								</form>
							</div>
